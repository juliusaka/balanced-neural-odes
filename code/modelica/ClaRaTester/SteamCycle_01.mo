...
//__________________________________________________________________________//
  ...
  ClaRa.Components.VolumesValvesFittings.Valves.GenericValveVLE_L1 valve_IP1(checkValve=true, redeclare model PressureLoss =
        ClaRa.Components.VolumesValvesFittings.Valves.Fundamentals.LinearNominalPoint (                                                                                                               Delta_p_nom=NOM.valve_IP1.Delta_p, m_flow_nom=NOM.valve_IP1.m_flow)) annotation (Placement(transformation(
        extent={{-10,-6},{10,6}},
        rotation=270,
        origin={90,-30})));
  ...
  ClaRa.Components.HeatExchangers.HEXvle2vle_L3_2ph_CH_simple preheater_HP(
    ...
    redeclare model HeatTransfer_Shell = ClaRa.Basics.ControlVolumes.Fundamentals.HeatTransport.VLE_HT.Constant_L3_ypsDependent (
  ...
  ClaRa.Components.Utilities.Blocks.LimPID PI_valveControl_preheater_HP(
    controllerType=Modelica.Blocks.Types.SimpleController.PI,
    y_max=1,
    y_min=0.01,
    Tau_i=10,
  ...
  ClaRa.StaticCycles.Check.StaticCycleExamples.InitSteamCycle_01 INIT(
    P_target_=P_target_INIT,
    ...
    valve_HP_Delta_p_nom=NOM.valve_HP_Delta_p_nom) annotation (Placement(transformation(extent={{-312,-198},{-292,-178}})));
  ...
  ClaRa.Components.VolumesValvesFittings.Fittings.JoinVLE_L2_Y join_LP_main(
    ...
    initOption=0,
    redeclare model PressureLossOut = ClaRa.Components.VolumesValvesFittings.Fittings.Fundamentals.Linear (
                                                                                                     m_flow_nom=420))
                  annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
  ...
  ClaRa.StaticCycles.Check.StaticCycleExamples.InitSteamCycle_01 NOM(
    final P_target_=1,
  ...
  ClaRa.Components.VolumesValvesFittings.Fittings.SplitVLE_L2_Y split_IP2(
    volume=0.1,
    initOption=0,
    ...
    p_start=INIT.Turbine_IP2.p_out) annotation (Placement(transformation(
        ...
        rotation=0,
        origin={90,40})));
  ClaRa.Components.VolumesValvesFittings.Fittings.SplitVLE_L2_Y join_IP3(
    volume=0.1,
    initOption=0,
    ...
    p_start=INIT.Turbine_IP3.p_out) annotation (Placement(transformation(
        ...
        rotation=0,
        origin={200,40})));
  ClaRa.Visualisation.Quadruple quadruple15 annotation (Placement(transformation(extent={{80,80},{140,100}})));
  ClaRa.Visualisation.Quadruple quadruple16 annotation (Placement(transformation(extent={{120,60},{180,80}})));
  ...
  ClaRa.Components.VolumesValvesFittings.Fittings.SplitVLE_L2_Y join_LP2(
    ...
    p_start=INIT.Turbine_LP2.p_out) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={310,40})));
  ClaRa.Components.VolumesValvesFittings.Fittings.SplitVLE_L2_Y split_LP3(
    volume=0.1,
    initOption=0,
    ...
    m_flow_out_nom={NOM.Turbine_LP2.summary.outlet.m_flow,NOM.preheater_LP4.summary.inlet_tap.m_flow}) annotation (Placement(transformation(
        ...
        rotation=0,
        origin={350,40})));
  ClaRa.Components.VolumesValvesFittings.Valves.GenericValveVLE_L1 valve_LP1(checkValve=true, redeclare model PressureLoss = ClaRa.Components.VolumesValvesFittings.Valves.Fundamentals.LinearNominalPoint (Delta_p_nom=NOM.valve_LP1.Delta_p, m_flow_nom=NOM.valve_LP1.m_flow)) annotation (Placement(transformation(
        extent={{-10,-6},{10,6}},
        rotation=270,
        origin={270,-30})));
  ...
  ClaRa.Components.HeatExchangers.HEXvle2vle_L3_2ph_CU_simple preheater_LP4(
    ...
    initOptionWall=1) annotation (Placement(transformation(
        ...
        rotation=180,
        origin={410,-124})));
  ClaRa.Components.TurboMachines.Pumps.PumpVLE_L1_simple Pump_preheater_LP3(
    showExpertSummary=true,
    eta_mech=0.9,
  ...
  ClaRa.Components.VolumesValvesFittings.Valves.GenericValveVLE_L1 valveControl_preheater_LP2(
    ...
    redeclare model PressureLoss = ClaRa.Components.VolumesValvesFittings.Valves.Fundamentals.LinearNominalPoint (
        ...
        rotation=90,
        origin={270,-150})));
  ClaRa.Components.VolumesValvesFittings.Fittings.JoinVLE_L2_Y join_preheater_LP3(
    volume=0.1,
    initOption=0,
    ...
    redeclare model PressureLossIn1 = ClaRa.Components.VolumesValvesFittings.Fittings.Fundamentals.Linear (m_flow_nom=NOM.m_flow_nom, dp_nom=10)) annotation (Placement(transformation(
        extent={{10,10},{-10,-10}},
        rotation=0,
        origin={304,-122})));
  ClaRa.Components.VolumesValvesFittings.Valves.GenericValveVLE_L1 valveControl_preheater_LP4(
    ...
    redeclare model PressureLoss = ClaRa.Components.VolumesValvesFittings.Valves.Fundamentals.LinearNominalPoint (
        ...
        rotation=0,
        origin={450,-170})));
  ClaRa.Components.VolumesValvesFittings.Valves.GenericValveVLE_L1 valve_LP2(checkValve=true, redeclare model PressureLoss = ClaRa.Components.VolumesValvesFittings.Valves.Fundamentals.LinearNominalPoint (Delta_p_nom=NOM.valve_LP2.Delta_p, m_flow_nom=NOM.valve_LP2.m_flow)) annotation (Placement(transformation(
        extent={{-10,-6},{10,6}},
        rotation=270,
        origin={340,-30})));
  ClaRa.Components.VolumesValvesFittings.Valves.GenericValveVLE_L1 valve_LP3(checkValve=true, redeclare model PressureLoss = ClaRa.Components.VolumesValvesFittings.Valves.Fundamentals.LinearNominalPoint (Delta_p_nom=NOM.valve_LP3.Delta_p, m_flow_nom=NOM.valve_LP3.m_flow)) annotation (Placement(transformation(
        extent={{-10,-6},{10,6}},
        rotation=270,
        origin={410,-30})));
  ClaRa.Components.BoundaryConditions.BoundaryVLE_Txim_flow boundaryVLE_Txim_flow(T_const=273.15 + 15, m_flow_const=25000) annotation (Placement(transformation(extent={{620,-80},{600,-60}})));
  ClaRa.Components.BoundaryConditions.BoundaryVLE_phxi boundaryVLE_phxi(p_const=2e5) annotation (Placement(transformation(extent={{620,-40},{600,-20}})));
  ClaRa.Components.Utilities.Blocks.LimPID PID_preheaterLP4(
    sign=-1,
    u_ref=0.1,
    y_ref=1,
    y_max=1,
  ...
  ClaRa.Components.Utilities.Blocks.LimPID PID_preheaterLP3(
    u_ref=0.2,
    Tau_in=0.8,
    Tau_out=0.8,
    sign=-1,
  ...
  ClaRa.Components.Utilities.Blocks.LimPID PID_NDVW3(
    Tau_in=0.8,
    Tau_out=0.8,
    sign=-1,
    controllerType=Modelica.Blocks.Types.SimpleController.PI,
  ...
  ClaRa.Visualisation.Quadruple quadruple17 annotation (Placement(transformation(
        extent={{-30,-10},{30,10}},
        rotation=0,
        origin={390,110})));
  ClaRa.Visualisation.Quadruple quadruple18 annotation (Placement(transformation(
        extent={{-30,-10},{30,10}},
        rotation=0,
        origin={410,90})));
  ...
  ClaRa.Components.Electrical.SimpleGenerator simpleGenerator(contributeToCycleSummary=true, hasInertia=true) annotation (Placement(transformation(extent={{542,40},{562,60}})));
  ClaRa.Components.BoundaryConditions.BoundaryElectricFrequency boundaryElectricFrequency annotation (Placement(transformation(extent={{602,40},{582,60}})));
  ClaRa.Visualisation.Quadruple quadruple19 annotation (Placement(transformation(
        extent={{-30,-10},{30,10}},
        rotation=0,
        origin={304,-50})));
  ClaRa.Visualisation.Quadruple quadruple20 annotation (Placement(transformation(
        extent={{-30,-10},{30,10}},
        rotation=0,
        origin={374,-50})));
  ClaRa.Visualisation.Quadruple quadruple21 annotation (Placement(transformation(
        extent={{-30,-10},{30,10}},
        rotation=0,
        origin={446,-50})));
  ClaRa.Visualisation.DynamicBar fillingLevel_preheater_LP1(
    u_set=0.1,
    u_high=0.2,
    u_low=0.05,
    provideInputConnectors=true) annotation (Placement(transformation(extent={{208,-134},{218,-114}})));
  ClaRa.Visualisation.DynamicBar fillingLevel_preheater_LP2(
    u_set=0.1,
    u_high=0.2,
    u_low=0.05,
    provideInputConnectors=true) annotation (Placement(transformation(extent={{278,-134},{288,-114}})));
  ClaRa.Visualisation.DynamicBar fillingLevel_preheater_LP3(
    u_set=0.1,
    u_high=0.2,
    u_low=0.05,
    provideInputConnectors=true) annotation (Placement(transformation(extent={{348,-134},{358,-114}})));
  ClaRa.Visualisation.DynamicBar fillingLevel_preheater_LP4(
    u_set=0.1,
    u_high=0.2,
    u_low=0.05,
    provideInputConnectors=true) annotation (Placement(transformation(extent={{418,-134},{428,-114}})));
  ClaRa.Visualisation.DynamicBar fillingLevel_condenser(
    u_set=0.5/6,
    u_high=0.5/3,
    u_low=0.5/12,
    provideInputConnectors=true) annotation (Placement(transformation(extent={{548,-60},{558,-40}})));
  ClaRa.Visualisation.DynamicBar fillingLevel_preheater_HP(
    provideInputConnectors=true,
    u_set=0.5,
    u_high=0.6,
    u_low=0.4) annotation (Placement(transformation(extent={{-80,-192},{-70,-172}})));
  ClaRa.Visualisation.DynDisplay valveControl_preheater_LP4_display(
    unit="p.u.",
    decimalSpaces=1,
  ...
  ClaRa.Visualisation.DynDisplay valveControl_preheater_LP2_display2(
    unit="p.u.",
    decimalSpaces=1,
  ...
  ClaRa.Visualisation.Quadruple quadruple24
    annotation (Placement(transformation(extent={{-30,-10},{30,10}},
        rotation=0,
        origin={444,-90})));
  ClaRa.Components.VolumesValvesFittings.Pipes.PipeFlowVLE_L4_Simple downComer_feedWaterTank(
    ...
    frictionAtInlet=true) annotation (Placement(transformation(
        ...
        rotation=270,
        origin={40,-159})));
  ClaRa.Visualisation.Quadruple quadruple25 annotation (Placement(transformation(
        extent={{-30,-10},{30,10}},
        rotation=0,
        origin={-140,-192})));
  ClaRa.Components.VolumesValvesFittings.Valves.GenericValveVLE_L1 valveControl_preheater_LP1(redeclare model PressureLoss = ClaRa.Components.VolumesValvesFittings.Valves.Fundamentals.LinearNominalPoint (
        ...
        rotation=0,
        origin={586,-30})));
  Modelica.Blocks.Interfaces.RealInput u          annotation (Placement(transformation(extent={{-348,-20},{-308,20}}), iconTransformation(extent={{-348,-20},{-308,20}})));
...
equation
  ...
  connect(condenser.Out2, valveControl_preheater_LP1.inlet) annotation (Line(
      ...
      pattern=LinePattern.Solid,
      thickness=0.5));
  connect(u, steamGenerator.QF_setl_) annotation (Line(points={{-328,0},{-168,0},{-168,57.875},{-156.8,57.875}}, color={0,0,127}));
  connect(u, Nominal_PowerFeedwaterPump1.u) annotation (Line(points={{-328,0},{-184,0},{-184,-280},{-28,-280},{-28,-272},{-16.8,-272}}, color={0,0,127}));
